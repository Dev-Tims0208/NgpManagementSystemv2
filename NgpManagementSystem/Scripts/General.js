...
function NgpTotalLogs() {
    ...
    $("#logstotaldatatabledeveloper").DataTable({
        "ajax": {
    ...
    $("#logstotaldatatableuser").DataTable({
        "ajax": {
            "url": "/Dashboard/NgpLogsTotalforUser",
            "type": "POST",
            "datatype": "json", dataSrc: "data"
        },
...
function TotalLogsTake() {
    $("#logsdatatabledevelopertake").DataTable({
        "ajax": {
            "url": "/Dashboard/NgpLogsDeveloperTake",
            "type": "POST",
            "datatype": "json", dataSrc: "data"
        },
    ...
    $("#logsdatatableadministratortake").DataTable({
        "ajax": {
            "url": "/Dashboard/NgpLogsAdministratorTake",
            "type": "POST",
            "datatype": "json", dataSrc: "data"
        },
    ...
    $("#logsdatatableusertake").DataTable({
        "ajax": {
            "url": "/Dashboard/NgpLogsUserTake",
            "type": "POST",
            "datatype": "json", dataSrc: "data"
        },
...
function ContractorAnimation() {
    ...
    $("#contractortable").on('click', '.editcontractor', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //added
                $('#editcontractorform').find('input[name="fruitTrees"]').val(data.fruitTrees);
                $('#editcontractorform').find('input[name="forestTrees"]').val(data.forestTrees);
                $('#editcontractorform').find('input[name="bamboo"]').val(data.bamboo);
                $('#editcontractorform').find('input[name="mangrove"]').val(data.mangrove);
    ...
    $("#UpdateRecord").click(function (e) {
        ...
        var data = {
            ...
            //added
            fruitTrees: $('#editcontractorform').find('input[name=fruitTrees]').val(),
            forestTrees: $('#editcontractorform').find('input[name=forestTrees]').val(),
            bamboo: $('#editcontractorform').find('input[name=bamboo]').val(),
            mangrove: $('#editcontractorform').find('input[name=mangrove]').val(),
        ...
        submitHandler: function () {
            if ($("#contract_main").valid()) {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        location.reload();
                        window.location.href = "/Information/Users";
                    }, 2000)
                }, 2000);
            }
        }
...
function AccountforAdministrator() {
    //SERVER SIDE DATATABLE SHOW DATA FOR USER

    $("#administratoraccounttable").DataTable({
        "ajax": {
            "url": "/Account/GetUAccountDatatablefoAdministrator",
            "type": "POST",
            "datatype": "json", dataSrc: "data"
        },
    ...
    //GET DATA ONLY FOR EDIT ACCOUNT GET METHOD 
    $('#administratoraccounttable').on('click', '.edit', function () {
        var id = $(this).attr('data-id');
        var url = '/api/editaccount/geteditaccount/' + id;
        /*    toastr.success(id);*/
    ...
    //GET DATA CHANGE IMAGE
    $('#administratoraccounttable').on('click', '.changephoto', function () {
        var id = $(this).attr('data-id');
        var url = '/api/editaccount/geteditaccount/' + id;
    ...
    //  //GET DATA ONLY FOR  RESET PASSWORD
    $('#administratoraccounttable').on('click', '.resetpass', function () {
        var id = $(this).attr('data-id');
        var url = '/api/editaccount/geteditaccount/' + id;
        /*    toastr.success(id);*/
        $.ajax({
    ...
    $('#administratoraccounttable').on('click', '.deleteaccount', function () {
        var id = $(this).attr('data-id');
        var url = '/api/accountdelete/getaccountdelete/' + id;
        $("#DeleteAccountId").val(id);
        $("#deleteAccountModal").modal('show');
